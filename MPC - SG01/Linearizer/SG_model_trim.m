...
% Longitudinal
opspec.States(1).SteadyState = true; % u
opspec.States(1).Known = false; % u

opspec.States(3).SteadyState = true; % w
opspec.States(3).Known = false; 

opspec.States(5).SteadyState = true; % Q 

opspec.States(7).SteadyState = true; % Pitch
opspec.States(7).Known = true; % Pitch

opspec.States(10).SteadyState = true; % Z 
opspec.States(10).Known = false; % Z 

% Lateral
opspec.States(2).SteadyState = 1; % v
opspec.States(4).SteadyState = 1; % P
opspec.States(6).SteadyState = 1; % R 
...
%% Perform the operating point search
    ...
    save('matfiles/trim_op_fixed_v.mat','op','opreport', ...
