...
% function [] = trim_boat_03(initial_uspeed,initial_Z)
...
x0 = [initial_uspeed; 0;0;0;0;0;0;0;0; initial_Z];
...
opspec.States(10).Known = foilborn;
...
%% Perform the operating point search
    ...
    % save('trim_op_fixed_v.mat','op','opreport','FF_L','FF_R','rear_alfas','T','gg','initial_uspeed','initial_wspeed','initial_Q','initial_Pitch','initial_Z','initial_vspeed','initial_P','initial_R','initial_ROLL','initial_YAW')
